      ...
      <div className="pt-6">
        ...
        <section className='grid grid-cols-1 lg:grid-cols-2 gap-x-8 gap-y-10 px-4 pt-10'>
            ...
            <div className="lg:col-span-2">
                ...
                <h1 className='text-lg lg:text-xl text-gray-900 opacity-60 pt-1'>Universal Outfit</h1>
            </div>
                ...
                <Grid container spacing={7}>
                    <Grid item xs={7}>
                        <div className='space-y-5'>
                            {[1,2,3].map((item)=> <ProductReviewCard></ProductReviewCard>)}
                        </div>
                    </Grid>
                    <Grid item xs={5}>
                        ...
                        <Box className="mt-5 space-y-3">
                            <Grid container alignItems={"center"} gap={2}>
                                ...
                                <Grid item xs={7}>
                                    <LinearProgress variant='determinate' sx={{bgcolor: "#d0d0d0", 
                                    borderRadius: 4, height: 7}} value={40} color='success'/>
                                </Grid>
                            </Grid>
                            <Grid container alignItems={"center"} gap={2}>
                                <Grid item xs={2}>
                                ...
                                <Grid item xs={7}>
                                    <LinearProgress variant='determinate' sx={{bgcolor: "#d0d0d0", 
                                    borderRadius: 4, height: 7}} value={35} color='success'/>
                                </Grid>
                            </Grid>
                            <Grid container alignItems={"center"} gap={2}>
                                <Grid item xs={2}>
                                ...
                                <Grid item xs={7}>
                                    <LinearProgress variant='determinate' sx={{bgcolor: "#d0d0d0", 
                                    borderRadius: 4, height: 7}} value={30} color='success'/>
                                </Grid>
                            </Grid>
                            <Grid container alignItems={"center"} gap={2}>
                                <Grid item xs={2}>
                                ...
                                <Grid item xs={7}>
                                    <LinearProgress variant='determinate' sx={{bgcolor: "#d0d0d0", 
                                    borderRadius: 4, height: 7}} value={25} color='warning'/>
                                </Grid>
                            </Grid>
                            <Grid container alignItems={"center"} gap={2}>
                                <Grid item xs={2}>
                                ...
                                <Grid item xs={7}>
                                    <LinearProgress variant='determinate' sx={{bgcolor: "#d0d0d0", 
                                    borderRadius: 4, height: 7}} value={20} color='error'/>
                                </Grid>
                            </Grid>
                        </Box>
                    </Grid>
